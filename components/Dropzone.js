...
const Dropzone = () => {
    ...
    const onDropRejected = () => {
        mostrarAlerta('no se pudo subir el límite es 1MB, obten una cuenta gratis para subir archivos mas grandes')
    }
                ...
                <div {...getRootProps({className: 'dropzone w-full py-32'})}>
                ...
                
                    {
                        ...
                        <div className='text-center'>
                            <p className='text-2xl text-center text-gray-600'>Selecciona un archivo y arrastra aquí</p>
